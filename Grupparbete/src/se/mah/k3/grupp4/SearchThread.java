...
//	}
	...
	public void print(Journeys journeys) {
		...
		try {
			...
			System.out.println(" Departs in " + journeys.getJourney(0).getRealDepTime() + " mothafukkin minutes");
			...
			System.out.println(" Departs in " + journeys.getJourney(1).getRealDepTime() + " mothafukkin minutes");
